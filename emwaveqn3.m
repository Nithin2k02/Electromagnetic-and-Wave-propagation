...
for j=1:0.01:5
    ...
    hold on
    p3=plot3(z,E1,E2,'b');
    quiver3(0,0,0,0,0,cos(w*i),'k','LineWidth',3);
    quiver3(0,0,0,0,cos(w*i+pi/2),0,'r','LineWidth',3);
    quiver3(0,0,0,0,cos(w*i+pi/2),cos(w*i),'b','LineWidth',3);
    ...
    title('LHCP','Color','k','FontSize',20)
    
    
    
    if j==1
        text(0,0,0,'Initially starting with a phase difference of pi/2 with Ey leading','Color','red','FontSize',14)
        pause(5);
    end
   hold off
